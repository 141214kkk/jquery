  ...
  <div class="common-layout">
    <el-container>
      <el-header class="common-header flex-float">
        <div class="flex">
          <img class="logo" src="../../assets/hu1.png" alt="" />
                    ...
                    <template #title> 
                     ...
                     <el-menu-item-group>
                        <el-menu-item index="/user">
                          <el-icon><Grid /></el-icon>账号列表</el-menu-item> 
                    </el-menu-item-group>
                </el-sub-menu>
                <el-sub-menu index="2">
                    <template #title>
                     ...
                     <el-menu-item-group>
                        <el-menu-item index="/roles">
                          <el-icon><Grid /></el-icon>角色列表</el-menu-item> 
                    </el-menu-item-group>
                </el-sub-menu>
                <el-sub-menu index="3">
                    <template #title>
                     ...
                     <el-menu-item-group>
                        <el-menu-item index="/goods">
                          <el-icon><Grid /></el-icon>商品列表</el-menu-item> 
                    </el-menu-item-group>
                </el-sub-menu>
            </el-menu>
        </el-aside>
